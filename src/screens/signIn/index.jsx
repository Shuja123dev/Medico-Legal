...
const SignIn = () => {
  ...
  return (
    <div className='container-fluid d-flex justify-content-center align-items-center'>
        <div className='signin-container d-flex justify-content-center align-items-center gap-5'>
              ...
              <div className='signin-form-container'>
                ...
                <div className='signin-form-inputs  d-flex flex-column gap-4 py-5'>
                  <div className='signin-form-input'>
                    <input type="text" name="phoneNumber" id="phoneNo" placeholder={t("SignIn.Placeholders.PhoneNo")} className='w-100 p-2' onChange={handleChange} dir={`${lang === 'en'?'ltr':'rtl'}`}/>
                  </div>
                  {
                  errors.phoneNumber && 
