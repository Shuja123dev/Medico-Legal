    ...
    <>
      <div className="user_upload_modal_div">
        {modalType === "documentUpload" && (
          <Dropzone content={t("UserPanel.Cases.AddNewCasePage.ClickToUploadDocument")} />
        )}
        {modalType === "addressUpload" && (
          <>
            <H3 text={t("UserPanel.Cases.AddNewCasePage.AddNationalAddress")} className="text-center" />
            <InputBox
