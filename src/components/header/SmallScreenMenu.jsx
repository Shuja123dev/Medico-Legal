    ...
    <div>
        ...
        <div className={`ham-menu ${!toggle ? 'd-none' : 'd-flex justify-content-center align-items-center'}`}>
            ...
            <ul className={`list-unstyled d-flex flex-column justify-content-center align-items-center gap-5`}>
                        <li className='pointer'><Link to={'/'} className='link' onClick={toggleMenu}>{t("Header.Home")}</Link></li>
                        <li className='pointer'><Link to={'/services'} className='link' onClick={toggleMenu}>{t("Header.Services")}</Link></li>
                        <li className='pointer'><Link to={'/blogs'} className='link' onClick={toggleMenu}>{t("Header.Blogs")}</Link></li>
                        <li className='pointer'><Link to={'/contact-us'} className='link' onClick={toggleMenu}>{t("Header.ContactUs")}</Link></li>
